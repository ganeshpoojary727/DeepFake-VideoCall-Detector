"""
FastAPI REST API Server for Deepfake Detection with Explainable AI Diagnostics.
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="REST API for static Image, Video, and Audio deepfake detection with XAI forensic diagnostics.",
        version="2.0.0",
        docs_url="/docs",
        redoc_url="/redoc",
    )
    ...
    async def detect_file(file: UploadFile = File(...)) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generate Explainable AI forensic breakdown
